...
// TASK 1 — DONE 2026-06-27: block 5 hours per booking to prevent double bookings.
// Each booking reserves the 5 hours starting at the booked time — the length of
// a detail plus a buffer. A 10:00 AM booking blocks 10:00 AM – 3:00 PM; nothing
// before the start time is blocked. The availability check uses the same window:
// a slot is taken if the 5-hour block starting there would overlap an existing
