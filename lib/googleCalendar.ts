...
// 5-hour window starting there would overlap an existing event, so a slot
// stays open only when a full 5-hour block fits before the next booking.
// TASK 1 (5-hour time blocks) — DONE 2026-06-24
