...
// same window: a slot is taken if the 5-hour detail starting there would
// overlap an existing event, so a slot stays open only when a full detail fits
// before the next booking. This 5-hour buffer prevents double bookings.
// DONE: Task 1 (5-hour booking time blocks) — 2026-06-28
