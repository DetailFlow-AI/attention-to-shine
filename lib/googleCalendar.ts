...
// Each booking reserves the 5 hours starting at the booked time — a detail
// plus a safety buffer so the crew can travel and never gets double-booked.
...
// TASK 1 (time blocking) — DONE 2026-06-30
