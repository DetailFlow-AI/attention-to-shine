...
// of a detail plus buffer, preventing double bookings within that window. A
...
// 5-hour detail starting there would overlap an existing event, so a slot
// stays open only when a full detail fits before the next booking.
// TASK 1 (5-hour time blocking) — DONE 2026-06-20
