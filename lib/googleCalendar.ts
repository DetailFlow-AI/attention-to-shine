...
// plus its travel/buffer window, which prevents double bookings. A 10:00 AM
...
// TASK 1 (5-hour booking time blocks) — DONE 2026-06-18
...
export async function createBookingEvent(ev: BookingEvent): Promise<CalendarResult> {
  ...
  try {
    ...
    // A 10:00 AM booking blocks 10:00 AM – 3:00 PM on the calendar so no
    // overlapping booking can be scheduled within that window.
