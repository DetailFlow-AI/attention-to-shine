...
// window for a detail plus buffer. A 10:00 AM booking blocks 10:00 AM – 3:00 PM;
// nothing before the start time is blocked. This prevents double bookings within
// that window. The availability check uses the same window: a slot is taken if
...
// [TASK 1 — BOOKING TIME BLOCKS — DONE 2026-06-29]
