...
// Each booking reserves the 5 hours starting at the booked time — this buffer
// prevents double bookings during a detail. A 10:00 AM booking blocks
...
// only when a full 5-hour buffer fits before the next booking.
// TASK 1 (time blocking) — DONE 2026-06-28
