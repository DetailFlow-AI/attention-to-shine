...
// for a full detail plus setup/teardown so back-to-back jobs never collide.
...
// the 5-hour window starting there would overlap an existing event, so a slot
// stays open only when a full 5-hour buffer fits before the next booking.
// DONE (Task 1 — 5-hour booking time blocks) — 2026-06-19
