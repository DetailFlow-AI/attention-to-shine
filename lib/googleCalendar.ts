...
// of a detail plus buffer, sized to prevent double bookings. A 10:00 AM
...
//
// TASK 1 (time blocking) — DONE 2026-06-24: bumped 3h → 5h to enforce the
// 10AM–3PM blocking window and stop double bookings within that buffer.
