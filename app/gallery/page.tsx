...
/* TASK 1 (Gallery: before & after matched pairs) — DONE 2026-07-06 */
...
// Each pair is the same vehicle photographed from the same area/angle,
// before the detail on the left and after on the right.
const beforeAfterPairs: BeforeAfterPair[] = [
  ...
  },
  {
    id: 3,
    category: "interior",
    title: "Driver Footwell Deep Clean",
  ...
  },
  {
    id: 7,
    category: "exterior",
    title: "Maverick Exterior Detail",
...
const exteriorPhotos: GalleryItem[] = [
  ...
  { id: 18, category: "exterior", src: "/images/exterior/IMG_4585.jpeg", alt: "Exterior detail 18" },
  { id: 19, category: "exterior", src: "/images/exterior/IMG_4671.jpeg", alt: "Exterior detail 19" },
  { id: 20, category: "exterior", src: "/images/exterior/IMG_6057.jpeg", alt: "Exterior detail 20" },
];
            ...
            <div className="mb-16">
              <div className="text-center mb-8">
                ...
                <p className="text-navy/60 mt-2">
                  Same vehicle, same angle — the only difference is our work.
                </p>
              </div>
              <div className="grid md:grid-cols-2 gap-6">
                {filteredPairs.map((pair) => (
                  <div
                    key={pair.id}
                    className="rounded-2xl overflow-hidden border border-navy/10 shadow-sm"
                  >
                    ...
                    <div className="px-4 py-3 bg-navy/5">
                      <p className="text-sm font-semibold text-navy">{pair.title}</p>
                    </div>
                  </div>
                ))}
              </div>
