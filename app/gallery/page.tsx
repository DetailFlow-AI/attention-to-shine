...
const exteriorPhotos: GalleryItem[] = [
  ...
  { id: 15, category: "exterior", src: "/images/exterior/IMG_4585.jpeg", alt: "Exterior detail 15" },
  ...
  { id: 18, category: "exterior", src: "/images/exterior/IMG_3777.jpeg", alt: "Exterior detail 18" },
];
...
const interiorPhotos: GalleryItem[] = [
  ...
  { id: 114, category: "interior", src: "/images/interior/IMG_6750.jpeg", alt: "Interior detail 14" },
];
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {beforeAfterPairs.map((pair) => (
              ...
              >
                ...
                <p className="text-center text-sm font-semibold text-navy py-3 px-4 bg-navy/5">
                  {pair.title}
                </p>
              </div>
            ))}
