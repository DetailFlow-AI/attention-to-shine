...
// TASK 1 (Gallery restructured into labeled Before & After pairs) — DONE 2026-07-02
...
const pairs: BeforeAfterPair[] = [
  {
    ...
    beforeSrc: "/images/exterior/IMG_3667.jpeg",
    afterSrc: "/images/exterior/IMG_1963.PNG",
  },
  {
    id: 2,
    category: "exterior",
    title: "Ford Maverick — Exterior Detail",
    beforeSrc: "/images/exterior/IMG_3584.jpeg",
    afterSrc: "/images/exterior/IMG_6035.jpeg",
  },
  {
    id: 3,
    category: "exterior",
    title: "Lincoln Navigator — Exterior Detail",
    beforeSrc: "/images/exterior/IMG_4585.jpeg",
    afterSrc: "/images/exterior/IMG_1956.PNG",
  },
  {
    id: 4,
    category: "exterior",
    title: "Ford F-150 — Exterior Detail",
    beforeSrc: "/images/exterior/IMG_1940.PNG",
    afterSrc: "/images/exterior/IMG_3235.jpeg",
  },
  {
    id: 5,
    category: "interior",
    title: "Sedan Footwell — Interior Deep Clean",
    beforeSrc: "/images/interior/IMG_1929.PNG",
    afterSrc: "/images/interior/IMG_1930.PNG",
  },
  {
    id: 6,
    category: "interior",
    title: "Driver's Seat & Carpet — Interior Deep Clean",
    beforeSrc: "/images/interior/IMG_5529.jpeg",
    afterSrc: "/images/interior/IMG_5567.jpeg",
  },
  {
    id: 7,
    category: "interior",
    title: "Floor Mats & Door Sill — Interior Deep Clean",
    beforeSrc: "/images/interior/IMG_5540.jpeg",
    afterSrc: "/images/interior/IMG_5561.jpeg",
  },
  {
    id: 8,
    category: "interior",
    title: "Dodge Charger Cabin — Interior Deep Clean",
    beforeSrc: "/images/interior/IMG_4666.jpeg",
    afterSrc: "/images/interior/IMG_1949.PNG",
  },
];
...
const morePhotos: GalleryItem[] = [
  ...
  { id: 19, category: "exterior", src: "/images/exterior/IMG_2525.jpeg", alt: "Exterior detail 19" },
  { id: 20, category: "exterior", src: "/images/exterior/IMG_3777.jpeg", alt: "Exterior detail 20" },
  { id: 21, category: "exterior", src: "/images/exterior/IMG_1959.PNG", alt: "Exterior detail 21" },
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-navy/60 text-center mb-10">
            Same vehicle, same angle — see exactly what a detail from us does.
          </p>
            ...
            {filteredPairs.map((pair) => (
              ...
              >
                <div className="grid grid-cols-2 gap-1">
                  <PairImage src={pair.beforeSrc} label="Before" title={pair.title} />
                  <PairImage src={pair.afterSrc} label="After" title={pair.title} />
                </div>
