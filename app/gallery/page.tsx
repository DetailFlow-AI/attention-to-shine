...
const interiorPhotos: GalleryItem[] = [
  ...
  { id: 112, category: "interior", src: "/images/interior/IMG_6750.jpeg", alt: "Interior detail 12" },
  { id: 113, category: "interior", src: "/images/interior/IMG_1930.PNG", alt: "Interior detail 13" },
...
function PairCard({ pair }: { pair: BeforeAfterPair }) {
  return (
    <div className="rounded-2xl overflow-hidden bg-navy/5 shadow-sm">
      <div className="grid grid-cols-2 gap-1">
        ...
        <div className="relative aspect-[3/4] bg-navy/10">
          <Image
            ...
            className="object-cover"
          />
          <span className="absolute top-3 left-3 bg-gold text-navy text-xs font-bold px-3 py-1.5 rounded-full backdrop-blur-sm">
            After
          </span>
        </div>
      </div>
      <p className="text-navy text-sm font-semibold px-4 py-3">{pair.title}</p>
    </div>
  );
}
