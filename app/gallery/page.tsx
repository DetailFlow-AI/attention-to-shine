...
const beforeAfterPairs: BeforeAfterPair[] = [
  ...
  },
  {
    id: 2,
    category: "interior",
    title: "Seat & Upholstery Deep Clean",
  ...
  },
  {
    id: 3,
    category: "interior",
    title: "Driver's Floor & Door Sill",
  ...
  },
  {
    id: 4,
    category: "interior",
    title: "Dodge Charger Interior Detail",
  ...
  },
  {
    id: 5,
    category: "exterior",
    title: "Chevy Camaro SS Exterior Detail",
  ...
  },
  {
    id: 6,
    category: "exterior",
    title: "Ford Maverick Exterior Wash",
  ...
  },
  {
    ...
    before: "/images/exterior/IMG_3235.jpeg",
    after: "/images/exterior/IMG_1940.PNG",
  },
];

// Photos already shown inside a before/after pair are excluded from the
// singles grid below so nothing appears twice.
...
const interiorPhotos: GalleryItem[] = [
  ...
  { id: 116, category: "interior", src: "/images/interior/IMG_6750.jpeg", alt: "Interior detail 13" },
];
    ...
    <div className="relative aspect-[4/3] overflow-hidden bg-navy/10">
      ...
      <span
        className={`absolute top-3 left-3 text-xs font-bold uppercase tracking-wide px-3 py-1.5 rounded-full backdrop-blur-sm pointer-events-none ${
          label === "Before" ? "bg-navy/80 text-white" : "bg-gold text-navy"
        }`}
      >
        {label}
      </span>
    ...
    <>
      ...
      <section className="bg-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Before & After pairs — same vehicle, same angle, before on the left */}
          <div className="text-center mb-10">
            <h2 className="text-3xl font-bold text-navy tracking-tight mb-2">
              Before &amp; After
            </h2>
            <p className="text-navy/60 max-w-xl mx-auto">
              Side-by-side comparisons of the same vehicle, so you can see
              exactly what a detail from us delivers.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-20">
            {filteredPairs.map((pair) => (
              ...
              >
                ...
                <p className="text-center text-sm font-semibold text-navy py-4">
                  {pair.title}
                </p>
              </div>
            ))}
