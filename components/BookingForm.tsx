...
export default function BookingForm({ defaultService }: { defaultService?: string }) {
  ...
  // TASK 1 — DONE 2026-06-18: each booking reserves a 5-hour buffer starting at
  // its time (a 10:00 AM booking blocks 10:00 AM–3:00 PM) — nothing before it.
  ...
  // existing detail. Mirrors the calendar block in lib/googleCalendar.ts.
