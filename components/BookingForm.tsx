...
export default function BookingForm({ defaultService }: { defaultService?: string }) {
  ...
  // A booking reserves 5 hours starting at its time (a 10:00 AM booking blocks
  // 10:00 AM–3:00 PM) — nothing before it. So a slot is bookable only if a full
  // 5-hour window starting there fits before the next booking, i.e. its
