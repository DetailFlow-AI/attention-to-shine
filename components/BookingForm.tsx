...
export default function BookingForm({ defaultService }: { defaultService?: string }) {
  ...
  // blocks 10:00 AM–3:00 PM) — nothing before it. This prevents double
  // bookings. So a slot is bookable only if a full 5-hour block starting there
  ...
  // TASK 1 (time blocking) — DONE 2026-07-02
