...
export default function BookingForm({ defaultService }: { defaultService?: string }) {
  ...
  // A detail reserves 5 hours. Each booking blocks the 5 hours starting at its
  // time (a 10:00 AM booking blocks 10:00 AM–3:00 PM) — nothing before it. So
  // a slot is bookable only if a full 5-hour detail starting there fits before
