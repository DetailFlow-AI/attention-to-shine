...
export default function BookingForm({ defaultService }: { defaultService?: string }) {
  ...
  // blocks 10:00 AM–3:00 PM) — nothing before it. This buffer prevents double
  // bookings. A slot is bookable only if a full 5-hour window starting there
  ...
  // [TASK 1 — 5-HOUR BOOKING TIME BLOCK — DONE 2026-06-29]
